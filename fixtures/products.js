module.exports = {
	available:
		[
			{
				query: "Смартфон Apple iPhone 11 64GB (черный)",
				catalogTitle: "Смартфон Apple iPhone 11 64GB (черный)",
			...
			},
			{
				...
				catalogTitle: "Процессор AMD Ryzen 5 3600",
			...
			},
			{
				...
				catalogTitle: "Холодильник side by side Samsung RS552NRUASL",
	...
	outOfStock:
		[
			...
			},
			{
				...
				catalogTitle: "Корпус Thermaltake Versa H26 Tempered Glass Edition CA-1J5-00M1WN-00",
			...
			},
			{
				...
				catalogTitle: "МФУ Kyocera Mita ECOSYS M6026cidn",
	...
	offSale:
		[
			...
			},
			{
				...
				catalogTitle: "Эспрессо кофемашина Philips HD8847/09",
			...
			},
			{
				...
				catalogTitle: "Велосипед GT Aggressor 1.0 Mech (2014)",
